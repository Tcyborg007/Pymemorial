...
def pytest_configure(config):
    ...
    config.addinivalue_line(
        "markers",
        "smoke: Smoke tests end-to-end (executados em CI/CD)"
    )
    config.addinivalue_line(
        "markers",
        "slow: Testes lentos (>1s, pulados em dev rápido)"
    )
    config.addinivalue_line(
        "markers",
    ...
    config.addinivalue_line(
        "markers",
        "unit: Testes unitários isolados (padrão)"
    )
    config.addinivalue_line(
        "markers",
        "requires_sympy: Requer SymPy instalado"
    )
    config.addinivalue_line(
        "markers",
        "requires_pint: Requer Pint instalado"
    )
